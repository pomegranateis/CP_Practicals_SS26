...
| File | Output URL |
|------|-----------|
| `q01.cpp` | ![alt text](outputs/1.png) |
| `q02.cpp` | ![alt text](outputs/2.png) |
| `q03.cpp` | ![alt text](outputs/3.png) |
| `q04.cpp` | ![alt text](outputs/4.png) |
| `q05.cpp` | ![alt text](outputs/5.png) |
| `q06.cpp` | ![alt text](outputs/6.png) |
| `q07.cpp` | ![alt text](outputs/7.png) |
| `q08.cpp` | ![alt text](outputs/8.png) |
| `q09.cpp` | ![alt text](outputs/9.png) |
| `q10.cpp` | ![alt text](outputs/10.png) |
